...
let levels: MentalMathLevel[] = [
    ...
    getLevel(4,1, 10, 1, 20, ['+'], 15, 15, 9, "Liitmine 20 piires (liidetavad kuni 10)"),
    getLevel(5,1, 10, 1, 20, ['-'], 15, 15, 9, "Lahutamine 20 piires (lahutaja ja lahutatav kuni 10)"),
    getLevel(6,1, 10, 1, 20, ['+', '-'], 15, 15, 9, "Liitmine ja lahutamine 20 piires (liidetavad, lahutatavad kuni 10)"),
    getLevel(7,1, 20, 1, 20, ['+'], 15, 15, 9, "Liitmine 20 piires (liidetavad kuni 20)"),
    getLevel(8,1, 20, 1, 20, ['-'], 15, 15, 9, "Lahutamine 20 piires (lahutaja ja lahutatav kuni 20)"),
    getLevel(9,1, 20, 1, 20, ['+', '-'], 15, 15, 9, "Liitmine ja lahutamine 20 piires (liidetavad, lahutatavad kuni 20)"),
]
